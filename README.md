...
CopyRail is an **early source MVP**, developed and tested on Apple Silicon macOS. The latest local iteration is **0.1.0-local-beta.19**. There is no Developer ID-signed, notarized binary release yet.
